...
This version supports continuous, non continuous sn-grams and without stop words or content sn-grams. It also supports 
mixed sn-grams (first element of one type and the rest of elements of different type)
